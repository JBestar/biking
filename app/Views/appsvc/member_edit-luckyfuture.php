<div class="main-container">
    <div class="main-content">
        ...
        <table class="layout-table">
            ...
            <tr>
                <td></td>
                <td><label>주문가능수량:</label></td>
                <td>
                    <?php if(is_null($member)) {  ?>	
                    <input type = "number" id="mb_prop_1" step="1"  style="width:160px;">
                    <?php } else {?>
                    <input type = "number" id="mb_prop_1" step="1" value="<?=$member->mb_prop_1?>"  style="width:160px;">
                    <?php } ?>    
                    <label style="font-size: 14px;">개</label>  
                </td>
                <td></td>
            </tr>
            <tr>
...
<script src="<?php echo base_url('/assets/js/appsvc/member_edit-luckyfuture.js');?>"></script>
